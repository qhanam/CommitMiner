...
public class MiningOptions {
	...
	return sourceDir == null ? null : new File(sourceDir);
    }

    @Option(name = "--candidates",
	    usage = "The path to the CSV file containing the transformation candidates.")
    private String candidates = null;

    public File getCandidatesFile() {
	return candidates == null ? null : new File(candidates);
    }
	...
	return outFile == null ? null : new File(outFile);
    }
