...
public class Address {
	...
	if (o instanceof Address) {
	    Address a = (Address) o;
	    if (this.prop.equals(a.prop) && this.addr.equals(a.addr))
		return true;
	}
	return false;
    }
     ...
     */
    public static BValue inject(Address address, Change valChange, Dependencies deps) {
	Set<Address> addresses = new HashSet<Address>();
	addresses.add(address);
	return BValue.inject(Str.bottom(), Num.bottom(), Bool.bottom(), Null.bottom(),
		Undefined.bottom(), new Addresses(addresses), valChange, deps);
    }
