 ...
 *
 * NOTE: Changes have been made to the original file protected under the license. // qhanam
 */
...
public class DiffMatchPatch {
  ...
  public enum Operation {
	...
	/**
	 * Find the line-level difference between two texts.
	 * @param text1 Old string to be diffed.
	 * @param text2 New string to be diffed.
	 * @return Linked list of Diff objects at the line-level.
	 */
	public LinkedList<Diff> diff_main_line_mode(String text1, String text2) {
  ...
  /**
   * Do a line-level diff on both strings. The diff is line-level minimal.
   *
   * @param text1 Old string to be diffed.
   * @param text2 New string to be diffed.
