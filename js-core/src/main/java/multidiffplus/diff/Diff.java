...
public class Diff {
	 ...
	 * @throws Exception thrown when a problem occurs during control flow differencing.
	 */
	public Diff(ICFGFactory cfgFactory, String[] args, String srcSourceCode, String dstSourceCode) throws Exception {
	 ...
	 */
	private static TreeContext createGumTree(ICFGFactory cfgFactory, String path, boolean preProcess) throws IOException {
	 ...
	 * @throws IOException When something goes wrong reading the source file.
	 */
	private static TreeContext createGumTree(ICFGFactory cfgFactory, String source, String path, boolean preProcess) throws IOException {
	 ...
	 */
	private static void classifyTreeNodes(TreeContext src, TreeContext dst, Matcher matcher) throws InvalidClassException {
